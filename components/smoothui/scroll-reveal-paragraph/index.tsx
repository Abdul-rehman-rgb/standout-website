...
export default function ScrollRevealParagraph({
  ...
  return (
    <p className={`text-2xl sm:text-3xl md:text-4xl lg:text-[44px] font-semibold text-[#171717] text-center sm:text-left text-lg leading-relaxed ${className}`} ref={container}>
      {words.map((word, i) => {
